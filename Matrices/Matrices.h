...
protected:
	...
	void InitializeGui()
	{
		...
		tbxEntrada2.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_AUTOVSCROLL | ES_MULTILINE | ES_WANTRETURN | ES_LEFT | ES_WINNORMALCASE, 211, 42, 127, 196, hWnd, 1005);
